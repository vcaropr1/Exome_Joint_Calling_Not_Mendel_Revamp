...
SCRIPT_DIR="/isilon/sequencing/VITO/NEW_GIT_REPO/Exome_Joint_Calling_Not_Mendel_Revamp/SNP_VQSR_And_Indel_Hard_Filtered/Scripts/"
...
APPLY_VARIANT_RECALIBRATION_SNV(){
echo \
 qsub \
 -N E05A-1_APPLY_VARIANT_RECALIBRATION_SNV_$PROJECT \
 -hold_jid E05A_VARIANT_RECALIBRATOR_SNV_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/E05A-1_APPLY_VARIANT_RECALIBRATION_SNV.log \
 $SCRIPT_DIR/E05A-1_APPLY_VARIANT_RECALIBRATION_SNV.sh \
 $JAVA_1_7 $GATK_DIR $REF_GENOME \
 $CORE_PATH $PROJECT_NAME $PREFIX
}
...
echo \
 ...
 -hold_jid E05B-1_HARD_FILTER_INDELS_$PROJECT','E05A-1_APPLY_VARIANT_RECALIBRATION_SNV_$PROJECT \
