...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.A01_COMBINE_GVCF_chr$CHROMOSOME.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.B02_GENOTYPE_GVCF_chr$CHROMOSOME.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.C03_VARIANT_ANNOTATOR_chr$CHROMOSOME.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.D04_CAT_VARIANTS.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.E05A_VARIANT_RECALIBRATOR_SNV.log \
...
echo \
 ...
 -hold_jid D04_CAT_VARIANTS_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.E05B_VARIANT_RECALIBRATOR_INDEL.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.F06_APPLY_RECALIBRATION_SNV.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.G07_APPLY_RECALIBRATION_INDEL.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08A_BGZIP_AND_TABIX_RECAL_VCF.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08B_CALCULATE_GENOTYPE_POSTERIORS.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.I09_VARIANT_ANNOTATOR_REFINED.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10_BGZIP_AND_TABIX_REFINED_VCF.log \
...
echo \
 ...
 -hold_jid I09_VARIANT_ANNOTATOR_REFINED_$PROJECT \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.K11_SELECT_VARIANTS_FOR_SAMPLE.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12A_BGZIP_AND_TABIX_SAMPLE_VCF.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12B_PASSING_VARIANTS_ON_TARGET_BY_SAMPLE.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12C_PASSING_SNVS_ON_BAIT_BY_SAMPLE.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12D_PASSING_SNVS_ON_TARGET_BY_SAMPLE.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12E_PASSING_INDELS_ON_BAIT_BY_SAMPLE.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12F_PASSING_INDELS_ON_TARGET_BY_SAMPLE.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12G_PASSING_SNVS_TITV_ALL.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12G-1_TITV_ALL.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12H_PASSING_SNVS_TITV_KNOWN.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12H-1_TITV_KNOWN.log \
...
echo \
 ...
 -hold_jid K11_SELECT_VARIANTS_FOR_SAMPLE_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12I_PASSING_SNVS_TITV_NOVEL.log \
...
echo \
 ...
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.L12I-1_TITV_NOVEL.log \
...
echo \
 ...
 -hold_jid L12G-1_TITV_ALL_$UNIQUE_ID_SM_TAG,L12H-1_TITV_KNOWN_$UNIQUE_ID_SM_TAG,L12I-1_TITV_NOVEL_$UNIQUE_ID_SM_TAG \
 -j y -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.$SM_TAG.M13_CONCORDANCE_ON_TARGET_PER_SAMPLE.log \
