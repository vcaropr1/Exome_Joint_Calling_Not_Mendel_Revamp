...
# $SAMTOOLS_DIR/bcftools/vcfutils.pl qstats $CORE_PATH/$PROJECT/TEMP/$SM_TAG".Release.Known.TiTv.vcf" >| \
# $CORE_PATH/$PROJECT/REPORTS/TI_TV_MS/$SM_TAG"_Known_.titv.txt"
