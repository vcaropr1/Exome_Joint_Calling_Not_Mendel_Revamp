...
echo \
 ...
 -hold_jid F06_APPLY_RECALIBRATION_SNV_$PROJECT \
...
echo \
 ...
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08A_BGZIP_AND_TABIX_RECAL_VCF.log \
...
echo \
 ...
 -hold_jid G07_APPLY_RECALIBRATION_INDEL_$PROJECT \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.H08B_CALCULATE_GENOTYPE_POSTERIORS.log \
...
echo \
 ...
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.I09_VARIANT_ANNOTATOR_REFINED.log \
...
echo \
 ...
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.J10_BGZIP_AND_TABIX_REFINED_VCF.log \
