...
echo \
 qsub \
 -N 01_COMBINE_GVCF_$PROJECT_chr$CHROMOSOME \
...
echo \
 qsub \
 -N 02_GENOTYPE_GVCF_$PROJECT_chr$CHROMOSOME \
 -hold_jid 01_COMBINE_GVCF_$PROJECT_chr$CHROMOSOME \
...
echo \
 qsub \
 -N 03_VARIANT_ANNOTATOR_$PROJECT_chr$CHROMOSOME \
 -hold_jid 02_GENOTYPE_GVCF_$PROJECT_chr$CHROMOSOME \
...
echo \
 ...
 $JAVA_1_7 $GATK_3_1_1_DIR $REF_GENOME \
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY $REF_GENOME $DBSNP \
 $CORE_PATH $PROJECT $PREFIX
}
...
# TITV_BED=[3]
# DBSNP=[4]
SAMPLE_INFO_ARRAY=(`sed 's/\r//g' $SAMPLE_SHEET | awk 'NR>1' | sed 's/,/\t/g' | sort -k 8,8 | uniq | awk '$8=="'$SAMPLE'" {print $1,$8,$17,$15,$18}'`)
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY $REF_GENOME \
 $CORE_PATH $PROJECT ${SAMPLE_INFO_ARRAY[1]} $PREFIX
}
...
echo \
 ...
 $TABIX_DIR \
 $CORE_PATH $PROJECT ${SAMPLE_INFO_ARRAY[1]}
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY $REF_GENOME \
 $CORE_PATH $PROJECT ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[2]}
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY $REF_GENOME \
 $CORE_PATH $PROJECT ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[3]}
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY $REF_GENOME $KNOWN_SNPS \
 $CORE_PATH $PROJECT ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[3]}
}
