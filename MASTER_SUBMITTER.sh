...
echo \
 ...
 $JAVA_1_7 $GATK_DIR ${PROJECT_INFO_ARRAY[1]} \
 $KEY $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $GVCF_LIST \
 $PREFIX $CHROMOSOME
 }
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR ${PROJECT_INFO_ARRAY[1]} \
 $KEY $CORE_PATH ${PROJECT_INFO_ARRAY[0]} \
 $PREFIX $CHROMOSOME
}
...
echo \
 ...
 $JAVA_1_7 $GATK_3_1_1_DIR ${PROJECT_INFO_ARRAY[1]} \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY ${PROJECT_INFO_ARRAY[1]} $HAPMAP_VCF $OMNI_VCF $ONEKG_SNPS_VCF $DBSNP_138_VCF \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY ${PROJECT_INFO_ARRAY[1]} $ONEKG_INDELS_VCF \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY ${PROJECT_INFO_ARRAY[1]} \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR_NIGHTLY $KEY ${PROJECT_INFO_ARRAY[1]} $P3_1KG $ExAC \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 ...
 $JAVA_1_7 $GATK_DIR $KEY ${PROJECT_INFO_ARRAY[1]} ${PROJECT_INFO_ARRAY[2]} \
 $CORE_PATH ${PROJECT_INFO_ARRAY[0]} $PREFIX
}
...
echo \
 qsub \
 -N 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 09_VARIANT_ANNOTATOR_REFINED_$PROJECT \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.11_SELECT_VARIANTS_FOR_SAMPLE.log \
 $SCRIPT_DIR/11_SELECT_VARIANTS_FOR_SAMPLE.sh \
 $JAVA_1_7 $GATK_DIR $KEY ${SAMPLE_INFO_ARRAY[5]} \
 $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]} $PREFIX
}

BGZIP_AND_TABIX_SAMPLE_VCF(){
echo \
 qsub \
 -N 12A_BGZIP_AND_TABIX_SAMPLE_VCF_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12A_BGZIP_AND_TABIX_SAMPLE_VCF.log \
 $SCRIPT_DIR/12A_BGZIP_AND_TABIX_SAMPLE_VCF.sh \
 $TABIX_DIR \
 $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]}
}

PASSING_VARIANTS_ON_TARGET_BY_SAMPLE(){
echo \
 qsub \
 -N 12B_PASSING_VARIANTS_ON_TARGET_BY_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12B_PASSING_VARIANTS_ON_TARGET_BY_SAMPLE.log \
 $SCRIPT_DIR/12B_PASSING_VARIANTS_ON_TARGET_BY_SAMPLE.sh \
 $JAVA_1_7 $GATK_DIR $KEY ${SAMPLE_INFO_ARRAY[5]} \
 $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[2]}
}

PASSING_SNVS_ON_BAIT_BY_SAMPLE(){
echo \
 qsub \
 -N 12C_PASSING_SNVS_ON_BAIT_BY_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12C_PASSING_SNVS_ON_BAIT_BY_SAMPLE.log \
...
echo \
 qsub \
 -N 12D_PASSING_SNVS_ON_TARGET_BY_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12D_PASSING_SNVS_ON_TARGET_BY_SAMPLE.log \
...
echo \
 qsub \
 -N 12E_PASSING_INDELS_ON_BAIT_BY_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12E_PASSING_INDELS_ON_BAIT_BY_SAMPLE.log \
...
echo \
 qsub \
 -N 12F_PASSING_INDELS_ON_TARGET_BY_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12F_PASSING_INDELS_ON_TARGET_BY_SAMPLE.log \
...
echo \
 qsub \
 -N 12G_PASSING_SNVS_ON_BAIT_AND_TITV_ALL_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12G_PASSING_SNVS_ON_BAIT_AND_TITV_ALL.log \
 $SCRIPT_DIR/12G_PASSING_SNVS_ON_BAIT_AND_TITV_ALL.sh \
 $JAVA_1_7 $GATK_DIR $KEY ${SAMPLE_INFO_ARRAY[5]} \
 $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[3]}
}

TITV_ALL(){
echo \
 qsub \
 -N 12G-1_TITV_ALL_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 12G_PASSING_SNVS_ON_BAIT_AND_TITV_ALL_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12G-1_TITV_ALL.log \
...
echo \
 qsub \
 -N 12H_PASSING_SNVS_ON_BAIT_AND_TITV_KNOWN_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12H_PASSING_SNVS_ON_BAIT_AND_TITV_KNOWN.log \
 $SCRIPT_DIR/12H_PASSING_SNVS_ON_BAIT_AND_TITV_KNOWN.sh \
 $JAVA_1_7 $GATK_DIR $KEY ${SAMPLE_INFO_ARRAY[5]} $KNOWN_SNPS \
 $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]} ${SAMPLE_INFO_ARRAY[3]}
}
...
echo \
 qsub \
 -N 12H-1_TITV_KNOWN_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 12H_PASSING_SNVS_ON_BAIT_AND_TITV_KNOWN_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12H-1_TITV_KNOWN.log \
...
echo \
 qsub \
 -N 12I_PASSING_SNVS_ON_BAIT_AND_TITV_NOVEL_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 11_SELECT_VARIANTS_FOR_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12I_PASSING_SNVS_ON_BAIT_AND_TITV_NOVEL.log \
...
echo \
 qsub \
 -N 12I-1_TITV_NOVEL_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 12I_PASSING_SNVS_ON_BAIT_AND_TITV_NOVEL_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.12I-1_TITV_NOVEL.log \
...
echo \
 qsub \
 -N 13_CONCORDANCE_ON_TARGET_PER_SAMPLE_${SAMPLE_INFO_ARRAY[1]} \
 -hold_jid 12G-1_TITV_ALL_${SAMPLE_INFO_ARRAY[1]},12H-1_TITV_KNOWN_${SAMPLE_INFO_ARRAY[1]},12I-1_TITV_NOVEL_${SAMPLE_INFO_ARRAY[1]} \
 -o $CORE_PATH/$PROJECT/LOGS/$PROJECT.${SAMPLE_INFO_ARRAY[1]}.13_CONCORDANCE_ON_TARGET_PER_SAMPLE.log \
